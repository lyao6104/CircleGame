/* Name: Larry Y.
 * Date: May 18, 2019
 * Desc: A slightly different AI than the basic one. */

using System.Collections;
using System.Collections.Generic;
using UnityEngine;

public class IntermediateAI : AIScript
{
	public float maxDistanceFactor; // All valid targets are at most this far away from the AI.
